        ...
        <div class="container text-left">
            <div class="row clearfix">
                <div class="profile-head-area clearfix">
                    <div class="profile-photo"><img src="<?=assets_url('user/img/profile-photo.jpg');?>" alt="">
                    </div>
                    <div class="prof-headings">
                        <h3 class="animated" data-animation="fadeInUp" data-animation-delay="100">Web Developer </h3>
                        <h5 class="uppercase animated" data-animation="fadeInUp" data-animation-delay="200"><i class="fi-mountains"></i> 5goat corporations</h5>
                        <hr class="animated" data-animation="fadeInUp" data-animation-delay="300"> </div>
                </div>
                <div class="profile-btns-main"> <a href="#" class="apply-btn">Apply</a> <a href="#" class="bookmark-btn"><i class="fi-bookmark"></i><sup><i class="fi-plus"></i></sup></a> </div>
            </div>
        </div>
    </section>
            ...
            <div class="row clearfix">
                <div class="col-md-12 full-width-area">
                    <div id="tab-container" class="tab-container animated" data-animation="fadeInUp" data-animation-delay="100">
                        <ul class="etabs">
                            <li class="tab"><a href="#tab-01">JOB INFORMATIONS</a>
                            </li>
                            <li class="tab"><a href="#tab-02">COMPANY INFORMATIONS</a>
                            </li>
                        </ul>
                        <div class="panel-container">
                            <div class="tab-cont" id="tab-01">
                                <ul class="info-list clearfix">
                                    <li>
                                        <label><i class="fi-calendar"></i> Posted on</label> <span>January 13, 2015</span>
                                    </li>
                                    <li>
                                        <label><i class="fi-database"></i> Job type</label> <span class="info-btn">Full-time</span>
                                    </li>
                                    <li>
                                        <label><i class="fi-folder"></i> Job category</label> <span>Design</span>
                                    </li>
                                    <li>
                                        <label><i class="fi-marker"></i> Location</label> <span>New york</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-cont" id="tab-02">
                                <ul class="info-list clearfix">
                                    <li>
                                        <label><i class="fi-folder"></i> Job category</label> <span>Design</span>
                                    </li>
                    ...
                    <div class="overview-detail animated" data-animation="fadeInUp" data-animation-delay="200">
                        ...
                        <div class="details-lists">
                            ...
                            <ul class="time-iconed">
                                <li>Qui dolorem ipsum quia dolor </li>
                                <li>Kuia voluptas sit aspernatur</li>
                                <li>Sed quia consequuntur </li>
                                <li>Magni dolores eos qui ratione</li>
                            </ul>
                            <h6>Qualifications</h6>
                            <ul class="time-iconed">
                                <li>Qui dolorem ipsum quia dolor
                                    <li>Kuia voluptas sit aspernatur</li>
                                    <li>Sed quia consequuntur </li>
                                    <li>Magni dolores eos qui ratione</li>
                            </ul>
