...
class Admin extends CI_Model {
	...
	{
		$this->db->select('yh_user_to_jobs.user_id,yh_user_to_jobs.rejected,yh_user_to_jobs.approved,yh_jobs.job_id,yh_jobs.grade_id,job_title,job_desc,yh_user_to_jobs.start_date,yh_user_to_jobs.end_date,yh_user_to_jobs.no_of_hours,fname,lname,grade_name');
		$this->db->from(TBL_JOBS);
